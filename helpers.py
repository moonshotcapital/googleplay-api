...
def print_header_line():
    l = ["Title", "Package name", "Creator", "Super Dev", "Price",
         "Offer Type", "Version Code", "Size", "Rating", "Num Downloads"]
...
def print_result_line(c):
    ...
    l = [c.title, c.docid, c.creator, len(c.annotations.badgeForCreator),
         c.offer[0].formattedAmount, c.offer[0].offerType,
